...
ligne += "<tr><td>" + data[i].id + "</td><td>" + data[i].date + "</td><td>" + data[i].code+ "</td><td>" + data[i].heureDebut + "</td><td>" + data[i].heureFin + "</td><td>" + data[i].matricule + "</td><td>" + data[i].statut + "</td></tr>"; } 
$("#content").html(ligne); 
}
