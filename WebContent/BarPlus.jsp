...
JFreeChart chart = ChartFactory.createBarChart("Les salles les plus reservees", "Code salle", "Nombre de reservation", dataset, PlotOrientation.VERTICAL, true, true, false);
