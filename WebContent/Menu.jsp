        ...
        %>
				...
				<li class="nav-item"><a class="nav-link"
					href="CrenonForm.jsp"> <i
						class="mdi mdi-contacts menu-icon"></i> <span class="menu-title">Gestion des crénoms</span>
				</a></li>
				<li class="nav-item"><a class="nav-link"
						...
						<ul class="nav flex-column sub-menu">
							<li class="nav-item"><a class="nav-link"
								...
								<div class="collapse" id="ui-basic">
									<ul class="nav flex-column sub-menu">
										<li class="nav-item"><a class="nav-link"
											href="LineGraph.jsp">Plus réservées</a></li>
						...
						<ul class="nav flex-column sub-menu">
							<li class="nav-item"><a class="nav-link"
								...
								<div class="collapse" id="ui-basic">
									<ul class="nav flex-column sub-menu">
										<li class="nav-item"><a class="nav-link"
											href="PiePlus.jsp">Plus réservées</a></li>
						...
						<ul class="nav flex-column sub-menu">
							<li class="nav-item"><a class="nav-link"
								...
								<div class="collapse" id="ui-basic">
									<ul class="nav flex-column sub-menu">
										<li class="nav-item"><a class="nav-link"
											href="BarPlus.jsp">Plus réservées</a></li>
